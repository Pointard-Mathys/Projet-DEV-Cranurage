...
# Create the table in the database
        query_create = f"CREATE TABLE IF NOT EXISTS "+name_table+" (name TEXT, rarity TEXT, attack TEXT, Reload_Recoil_Bullet_Speed TEXT, ammo TEXT, slots TEXT, rank TEXT, price TEXT, creation_mats TEXT, upgrade_mats TEXT, description TEXT) DEFAULT CHARACTER SET eucjpms COLLATE eucjpms_bin;"
        cursor = conn.cursor()
        cursor.execute(query_create)
...
# Create the table in the database
        query_create = f"CREATE TABLE IF NOT EXISTS "+name_table+" (name TEXT, rarity TEXT, attack_attribute TEXT, charge_stage TEXT, coatings TEXT, slots TEXT, rank TEXT, price TEXT, creation_mats TEXT, upgrade_mats TEXT, description TEXT) DEFAULT CHARACTER SET eucjpms COLLATE eucjpms_bin;"
        cursor = conn.cursor()
        cursor.execute(query_create)
